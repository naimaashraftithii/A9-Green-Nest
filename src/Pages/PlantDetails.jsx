    ...
    <div className="container mx-auto py-10 grid lg:grid-cols-2 gap-8 text-gray-900 ">
      ...
      <div>
        ...
        <form onSubmit={handleBook} className="mt-6 space-y-3 max-w-md">
          ...
          <input type="text" name="name" placeholder="Name" className="input input-bordered bg-gray-300 w-full" required />
          <input type="email" name="email" placeholder="Email" className="input input-bordered bg-gray-300 w-full" required />
